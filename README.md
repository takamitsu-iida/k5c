...
同じサブネット上にルータが2台接続される場合、どの宛先はどっち、という制御が必要です。

DHCPのオプション121（だったかな？）でVMに伝えます。
経路を追加、削除した場合はVMを再起動しないと伝搬しません。
...
> 必要だと思っていますが、どの資料をみても、必要だとは書いてない・・・


## ネットワークコネクタへのルーティング設定

K5→外部方向は、申請書にもとづいてルーティング設定をしてもらいます。

外部方向→K5は、BGPで伝えます。


> 正直、この辺りの経路制御に対する理解はまだあやふやです。
>
