...
"""
DELETE /v2.0/fw/firewalls/{firewall-id}
Delete firewall
ファイアーウォールを削除する

NOTE:
　・ルータに適用されていても削除できる（というか、ルータへの適用を外す方法はない）
"""

"""
実行例（成功した場合は特にデータは戻りません）

bash-4.4$ ./bin/k5-delete-firewall.py 2a323a21-23fc-4ec7-86d3-e1f900ba6876
status_code: 204
...
if __name__ == '__main__':
  ...
  def main():
    """メイン関数"""
    parser = argparse.ArgumentParser(description='Deletes a firewall.')
